...
public class ControladorPila {
    ...
    private final VistaPila ent;
    private final Validar val;
    private final admonPila.AdmonPila admPil;
    ...
    public ControladorPila(estudiantes est, SalidasPariales salPar, Totales tot, Validar val, VistaPila ent) {
        this.est = est;
        this.salPar = salPar;
        this.tot = tot;
        this.ent = ent;
        this.val = val;
        this.admPil = new admonPila.AdmonPila(ent);
        ...
        this.salPar.getBtnVolver().addActionListener(e -> {btnVolverAPila();});
        this.tot.getBntVolver().addActionListener(e -> {btnVolverAPila();});
    ...
    private void inicializarVentanaPrincipal() {
        ...
        ventanaPrincipal.setSize(800, 640);
    ...
    public void btnBuscarIdeEst() {
        ...
        estudiantes encontrado = admPil.buscarPorIdentificacion(ide);
        if (encontrado != null) {
            ArrayList<estudiantes> resultado = new ArrayList<>();
            resultado.add(encontrado);
            admPil.mostrarResultadosBusqueda(resultado);
        } else {
    ...
    public void btnBuscarapeEst() {
        ...
        ArrayList<estudiantes> resultados = admPil.buscarPorApellido(apellido);
        admPil.mostrarResultadosBusqueda(resultados);
    }
    ...
    public void btnBuscarnomEst() {
        ...
        ArrayList<estudiantes> resultados = admPil.buscarPorNombre(nombre);
        admPil.mostrarResultadosBusqueda(resultados);
    }
    ...
    public void btnBuscarproSem() {
        ...
        try {
            ...
            ArrayList<estudiantes> resultados = admPil.buscarPorPromedio(promedio);
            admPil.mostrarResultadosBusqueda(resultados);
    ...
    public void btnBuscarvalmatSem() {
        ...
        try {
            ...
            ArrayList<estudiantes> resultados = admPil.buscarPorValorMatricula(valor);
            admPil.mostrarResultadosBusqueda(resultados);
        } catch (NumberFormatException e) {
    ...
    public void titulo() {
        ventanaPrincipal.setTitle("Pila de estudiantes");
        ventanaPrincipal.setLocationRelativeTo(null);
